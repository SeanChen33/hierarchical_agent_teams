...
# OpenAI-compatible endpoint for 阿里云百炼（DashScope 兼容模式）
...
if not BAILIAN_API_KEY:
    # We avoid hardcoding any secret; require env to be set
    raise RuntimeError(
        "BAILIAN_API_KEY not set. Please export it or create backend/.env with BAILIAN_API_KEY=..."
    )

app = FastAPI(title="LangGraph + 百炼 SSE Chat")
